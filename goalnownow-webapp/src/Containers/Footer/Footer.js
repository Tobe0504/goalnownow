  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.textSection}>
        ...
        <p>
          The number one destination for real time scores for Football, Cricket,
          Tennis, Basketball, Hockey and more. Goalnownow is the go-to
          destination for latest football scores and news from around the world.
        </p>
        <p>
          Up to date tables, fixtures and scores from all the major leagues and
          competitions throughout the world live as they happen including the
          Premier League, La Liga, Serie A, Bundesliga, Ligue 1 and Europe’s
          biggest competitions such as the Champions League and Europa League.
        </p>
        <p>
          ...
          fingertips. With match info and line-ups thrown into the mix, you need
          not look anywhere else for football statistics.
        </p>
        <p>&copy; 2022 Goalnownow</p>
      </div>
